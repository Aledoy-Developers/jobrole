    ...
    <section class="speakers-section">
        <div class="container">
            ...
            <div class="speakers-grid">
                ...
                <!-- Speaker 8 -->
                <div class="speaker-card">
                    <img src="images/bunmi.jpg" alt="Bunmi Jembola" class="speaker-image">
                    <div class="speaker-info">
                        <h3>Mr Bunmi Jembola</h3>
                        <p class="position">CEO, SalesRuby</p>
                        <p class="bio">A serial entrepreneur and management consultant of note with about 2 decades experience in the corporate world.
