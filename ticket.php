<section class="tickets-section py-5">
  ...
  <h1 class="section-label">Tickets & Participation</h1>
  <h2 class="section-title">Choose Your Access Level</h2>
  <h1 class="section-subtitle">
    Select the pass that matches your ambition. <br> Every tier gets you into the room where Africa's future is being built.
</h1>
</div>
    ...
    <div class="savings-badge">
      ...
      <!-- CARD 3 -->
      <div class="ticket-card">
        <p class="tier-label">STRATEGY SQUAD: CORPORATE  (Team of 5)</p> <br>
        <h4 class="ticket-tagline">For Corporate Departments & Leadership Teams</h4>
        <p>
          Align your department's strategy in real-time. Bring your marketing, tech, and operations leads into the same room to build your Q4 roadmap.
        </p>
       <div class="price-wrapper">
